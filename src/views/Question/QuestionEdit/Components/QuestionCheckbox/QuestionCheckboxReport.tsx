...
import { CHART_COLORS3, REPORT_COMPONENT_HEIGHT } from '@/constant';
...
const QuestionCheckboxReport: FC<ReportDataType> = (props: ReportDataType) => {
            ...
            <PieChart>
              ...
              >
                {data.map((entry, index) => (
                  <Cell key={`cell-${index}`} fill={CHART_COLORS3[index % CHART_COLORS3.length]} />
                ))}
              </Pie>
              <Tooltip />
              <Legend></Legend>
...
export default QuestionCheckboxReport;
